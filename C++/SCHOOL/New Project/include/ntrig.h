...
void
trigGraphs::sinGraph(coordinate c1, mod m1, int color) {
...
void
trigGraphs::cosGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.x = 320 + (m1.coeffX * i);
...
void
trigGraphs::tanGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.x = 320 + (m1.coeffX * i);
...
void
trigGraphs::cotGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.x = 320 + (m1.coeffX * i);
...
void
trigGraphs::secGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.x = 320 + (m1.coeffX * i);
...
void
trigGraphs::cosecGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.x = 320 + (m1.coeffX * i);
