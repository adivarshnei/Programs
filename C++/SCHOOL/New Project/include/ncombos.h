...
#   ifndef _conmbo_classes_
#      define _conmbo_classes_
...
double
constituents::sinComboX(double i, mod m1) {
   double sinC;
...
double
constituents::cosComboX(double i, mod m1) {
   double cosC;
...
double
constituents::tanComboX(double i, mod m1) {
   double tanC;
...
double
constituents::cotComboX(double i, mod m1) {
   double cotC;
...
double
constituents::secComboX(double i, mod m1) {
   double secantC;
...
double
constituents::cosecComboX(double i, mod m1) {
   double cosecantC;
...
string*
comboGraphs::addComboGraph(coordinate c1, int color) {
   ...
   switch ( ch1.baseChoice ) {
   case 1:
      cout << mBase.coeffY << "y=" << mBase.coeffX << "sin(" << mBase.arg
           << "x)+";
   ...
   case 2:
      cout << mBase.coeffY << "y=" << mBase.coeffX << "cos(" << mBase.arg
           << "x)+";
   ...
   case 3:
      cout << mBase.coeffY << "y=" << mBase.coeffX << "tan(" << mBase.arg
           << "x)+";
   ...
   case 4:
      cout << mBase.coeffY << "y=" << mBase.coeffX << "cot(" << mBase.arg
           << "x)+";
   ...
   case 5:
      cout << mBase.coeffY << "y=" << mBase.coeffX << "sec(" << mBase.arg
           << "x)+";
   ...
   case 6:
      cout << mBase.coeffY << "y=" << mBase.coeffX << "cosec(" << mBase.arg
           << "x)+";
...
string*
comboGraphs::mulComboGraph(coordinate c1, int color) {
   history graphBase, graphAdd;
   string  final[100];
...
string*
comboGraphs::nestComboGraph(coordinate c1, int color) {
   history graphBase, graphAdd;
   string  final[100];
...
#   ifndef _times_func_used_
#      define _times_func_used_

typedef struct timesUsedVar {
   int sinUsed;
   int cosUsed;
   int tanUsed;
   int cotUsed;
