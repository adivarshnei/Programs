...
void
invTrigGraphs::invSinGraph(coordinate c1, mod m1, int color) {
...
void
invTrigGraphs::invCosGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.y = 250 + (m1.coeffY * i);
...
void
invTrigGraphs::invTanGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.y = 250 + (m1.coeffY * i);
...
void
invTrigGraphs::invCotGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.y = 250 + (m1.coeffY * i);
...
void
invTrigGraphs::invSecGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.y = 250 + (m1.coeffY * i);
...
void
invTrigGraphs::invCosecGraph(coordinate c1, mod m1, int color) {
   for ( double i = -320; i < 320; i += 0.01 ) {
      c1.y = 250 + (m1.coeffY * i);
