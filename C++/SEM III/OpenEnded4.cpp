...
template <typename T>
inline void
limitValue(T& value, const T lowerLimit, const T upperLimit) {
...
public:
   ...
   getData() {
      ...
      try {
         std::cout << "Enter the period of Slot 1 (Between 1 and 50): ";
   ...
   showData() const {
      ...
      std::cout << "Initial Tax Amout: " << this->initTax << std::endl;
