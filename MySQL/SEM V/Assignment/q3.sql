...
SELECT E.ENAME, MIN(E.SALARY), E.MGR_E_ID
FROM Employee_0129 E
GROUP BY E.MGR_E_ID;
...
-- number of employees
SELECT COUNT(E1.E_ID), YEAR(E1.HIREDATE)
FROM Employee_0129 E1
GROUP BY YEAR(E1.HIREDATE)
HAVING COUNT(E1.E_ID) IN (
...
SELECT E1.*
FROM Employee_0129 E1
WHERE YEAR(E1.HIREDATE) = 1983 AND E1.SALARY > (
    SELECT AVG(E2.SALARY)
    FROM Employee_0129 E2
    WHERE E1.DEPT_NO = E2.DEPT_NO
);
...
SELECT E.ENAME, M.ENAME, E.DEPT_NO AS MNAME
...
SELECT E.ENAME, E.LOC, D.DEPT_NAME
FROM Employee_0129 E, Department_0129 D
...
SELECT E.ENAME, E.JOB, E.SALARY, E.GRADE, D.DEPT_NAME
FROM Employee_0129 E, Department_0129 D
