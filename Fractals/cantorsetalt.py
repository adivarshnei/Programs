...
def cantorSetAlt(screen, screenParams, left, top, width, height, index):
    ...
    cantorSetAlt(screen, screenParams, left, top + 30, partWidth, height, index + 1)
    cantorSetAlt(screen, screenParams, left + 2 * partWidth, top + 30, partWidth, height, index + 1)
...
def main():
    ...
    while running:
        ...
        if not runChk:
            cantorSetAlt(screen, screenParams, 0, 200, screenParams['dimensions'][0], 20, 0)
            runChk = True
